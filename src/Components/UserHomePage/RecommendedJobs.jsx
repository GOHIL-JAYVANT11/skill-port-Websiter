...
import { MapPin, DollarSign, Bookmark, ChevronRight, BrainCircuit, Sparkles } from 'lucide-react';
...
const RecommendedJobs = () => {
  const jobs = [
    ...
    },
    {
      ...
      logo: 'https://cdn-icons-png.flaticon.com/512/5968/5968263.png',
      location: 'Remote',
      salary: '12 - 18 LPA',
      ...
      <div className="flex items-center justify-between mb-5 px-1">
        <div>
          <h2 className="text-lg font-black text-slate-900 flex items-center gap-2">
            ...
            <span className="px-2 py-0.5 bg-teal-50 text-teal-700 text-[9px] font-black rounded-full uppercase tracking-widest border border-teal-100">32 New</span>
          </h2>
